...
export default function CaseStudySideNav({ sections, extraItem }: CaseStudySideNavProps) {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed top-[100px] left-[48px] z-40 flex h-10 w-10 items-center justify-center rounded-full border border-border bg-white/75 text-fg shadow-[0_12px_30px_rgba(16,24,40,0.12)] backdrop-blur-sm transition-colors duration-300 hover:bg-white"
      >
        <ListIcon />
      </button>
    );
  ...
  return (
    ...
    <aside className="fixed top-[100px] left-[48px] z-40 w-[252px] rounded-2xl border border-border bg-white/75 p-5 shadow-[0_12px_30px_rgba(16,24,40,0.12)] backdrop-blur-sm">
