      ...
      <div className="mx-auto max-w-[1200px] px-8">
        <div className="grid grid-cols-1 items-center gap-16 md:grid-cols-[1.2fr_1fr] md:gap-30">
          <Reveal>
            ...
            <h2 className="mb-8 font-serif text-[36px] leading-[1.05] font-bold tracking-[-0.03em] text-fg md:text-h1">
              Open to new
              <br />
              collaborations.
            </h2>
            <p className="max-w-[420px] font-serif text-body-sm text-fg-secondary">
          ...
          <Reveal delay={0.1} className="flex flex-col gap-8">
            <div className="flex flex-col gap-1">
              ...
              <span className="font-serif text-body-sm font-medium text-fg">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="font-serif text-body-sm font-medium text-fg">Berlin, Germany (UTC+2)</span>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-[11px] tracking-[0.1em] text-fg-secondary uppercase">Availability</span>
              <span className="font-serif text-body-sm font-medium text-available">Open to opportunities</span>
            </div>
